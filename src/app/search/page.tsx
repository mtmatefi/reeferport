...
export default function SearchPage() {
  ...
  const results = useMemo(() => {
    let res = listings.filter((l) => {
      ...
      const matchQuery =
        ...
        l.latin.toLowerCase().includes(q) ||
  ...
  return (
    <div className="pb-28">
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              className="absolute left-3.5 top-1/2 -translate-y-1/2 text-white/36"
            >
          ...
          <button
            ...
            className={`flex h-[46px] w-[46px] items-center justify-center border transition ${
              showFilters || selectedCats.size > 0 || minPrice || maxPrice
                  ...
                  <button
                    ...
                    className={[
                      ...
                      selectedCats.has(cat)
                        ...
                        : "border-white/8 text-white/44 hover:border-white/18",
                    ].join(" ")}
                  >
                    {cat}
                  </button>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  placeholder="Von"
                  className="w-full border border-white/10 bg-white/4 px-3 py-2 text-[14px] text-white/80 placeholder-white/28 focus:border-white/24 focus:outline-none"
                />
      ...
      {/* Sort + result count */}
      <div className="flex items-center gap-3 overflow-x-auto px-5 py-3 no-scrollbar border-b border-white/6">
