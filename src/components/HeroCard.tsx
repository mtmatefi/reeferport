    ...
    <section className="mb-6 lg:mb-0">
      <Link href={`/listing/${listing.id}`} className="group relative block overflow-hidden bg-black">
        <img
          src={listing.image}
          alt={listing.title}
          className="h-[340px] sm:h-[420px] lg:h-[500px] w-full object-cover transition-transform duration-700 group-hover:scale-[1.02]"
        />
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6">
          <div className="mb-3 flex items-end justify-between gap-4">
            <div>
              ...
              <h2 className="text-[28px] sm:text-[34px] font-semibold leading-[0.92] tracking-[-0.06em] text-white">
                {listing.title}
              </h2>
          ...
          <p className="max-w-[280px] text-[13px] leading-[1.5] text-white/62">
            {listing.subtitle}
          </p>
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            />
            <span className="text-[12px] text-white/52">{listing.seller.name}</span>
